...
class pdosysql {
	...
	*/
	public function __construct () {
		...
		!$dbport && $dbport=3306;
		$dsn='mysql:host='.$dbhost.';port='.$dbport.';dbname='.$this->dbName.';charset=utf8';
		try {
...
/*
	...
	*/
	private function DisplayError ($info,$sql,$error) {
		exit(json_encode(array('success'=>0,'errcode'=>101,'errmsg'=>'Internal Server Error','errtype'=>'sql')));
	}
